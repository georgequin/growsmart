...
class _OrderListState extends State<OrderList> {
  ...
  ValueNotifier<PaymentMethod> selectedOrderPaymentMethod = ValueNotifier(PaymentMethod.binancePay);
                                            ...
                                            Row(children: [
                                              Expanded(
                                                child: ElevatedButton(
                                                  onPressed: () async {
                                                    List<String> orderIds = [order.id!];
                                                    ApiResponse res = await MoneyUtils().chargeCardUtil(PaymentMethod.wallet, orderIds, context, (order.product!.productPrice! + order.product!.shippingFee!));
