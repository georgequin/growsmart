      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            _buildInfoContainer("Name", "Amrah Uthman Sali"),
            _buildInfoContainer("Date of Birth", "01 Jan 1995"),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 8),
                  Text("Check out the latest products!", style: TextStyle(fontSize: 16)),
                ],
              ),
            ),
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Delivery Status", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                  SizedBox(height: 8),
                  Text("Your recent order is out for delivery", style: TextStyle(fontSize: 16)),
                ],
              ),
            ),
          ],
